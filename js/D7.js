...
function concat(str1, str2) {
  const parte1 = str1.split("").slice(0, 2).join("");
  const parte2 = str2.split("").slice(-3).join("");
  const concatenazione = parte1 + parte2.toUpperCase();
...
const numeriDispari2 = numeriDispari();
